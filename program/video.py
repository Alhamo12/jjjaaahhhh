    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
              ...
              [InlineKeyboardButton("ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸", url=f"t.me/{OWNER_NAME}"),
                    ...
                    if amort == 0:
                        ...
                        if chat_id in QUEUE:
                            ...
                            try:
                                ...
                                await loser.delete()
                                await m.reply_text(f"🚫 error قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر عنه @{ASSISTANT_NAME} : `{ep}`")
